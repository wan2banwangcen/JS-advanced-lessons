...
//通过Object方法创建JS对象   注：JS对象是通过原型链的方式实现的对象继承
var newObj = Object.create(obj);//newObj的原型是obj
newObj.age = 23;
console.log(newObj.num);//继承属性 10
console.log(newObj.str);//继承属性 Hi
console.log(newObj.show());//继承属性 Hi
...
o.bar;//10
o.bar=13;//Setting 'o.bar' to 13
o.bar;//10  configurable的属性为false，bar不能更改
*/
