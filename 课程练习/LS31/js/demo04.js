...
//Set解构的实例的forEach方法，用于对每个成员执行某种操作，没有返回值
...
//而且，数组的map和filter方法也可以间接用于Set了，通过...转成数组后再生成set
...
//Set {1,2,3,4}
//交集
let intersect=new Set([...a].filter(z=>b.has(x)));
//Set {2,3}
